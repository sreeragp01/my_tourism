...
urlpatterns = [
    ...
    path('plans/<uuid:id>/diff/', PlanDiffView.as_view(), name='ai-plan-diff'),
    path('plans/<uuid:id>/revert/', PlanRevertView.as_view(), name='ai-plan-revert'),
    path('plans/<uuid:id>/candidates/', PlanCandidatesView.as_view(), name='ai-plan-candidates'),
